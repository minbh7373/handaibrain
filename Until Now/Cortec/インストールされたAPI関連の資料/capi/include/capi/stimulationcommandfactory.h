...
*
* Example: Using createRectStimulationAtom(12, 2000000) would return
* a stimulation atom that stimulates with 12 micro ampere for 2 seconds.
*
* @param[in] hStimCommandFactory Handle to stimulation command factory (must be initialized).
* @param[out] stimulationAtom    Rectangular stimulation atom.
* @param[in] value               Stimulation amplitude in uA.
...
* @param[in] amplitude0          First stimulation amplitude in uA.
* @param[in] amplitude1          Second stimulation amplitude in uA.
* @param[in] amplitude2          Third stimulation amplitude in uA.
* @param[in] amplitude3          Fourth stimulation amplitude in uA.
* @param[in] duration            Duration in micros of the stimulation.
*
* @return Indicator for successful code execution (STATUS_OK on success)
*/
